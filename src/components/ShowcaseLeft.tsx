...
export default function ShowcaseLeft() {
  return (
    <section className="pt-10 px-4 mx-auto max-w-7xl flex justify-center">
      <div className="flex flex-col lg:flex-row items-center justify-between lg:space-x-28 space-y-10 lg:space-y-0">
        {/* Image + décor */}
        <div className="relative w-full max-w-sm aspect-[4/5] flex justify-center items-center">
          ...
          {/* Image principale */}
          <Image
            src="/assets/images/showcase-left.webp"
            alt="Showcase"
            fill={false}
            width={400}
            height={500}
            className="relative z-10 border w-full h-full object-cover  border-black"
          />

          {/* Image produit superposée */}
          <Image
            src="/assets/images/showcase-left-product.webp"
            alt="Produit"
            width={96}
            height={96}
