  ...
  return (
    <main className="bg-[#E5BC38]">
      ...
      <div className="bg-[#FFF6DA]">
        <div className="max-w-7xl mx-auto px-4 lg:px-0 py-10 flex flex-col lg:flex-row items-center justify-between space-y-10 lg:space-y-0 lg:space-x-28">
          <div className="space-y-5 flex-1">
            <h3 className="text-xl sm:text-lg quentin">About us</h3>
            ...
            <button className="relative w-full md:w-[9rem] h-11 group focus:outline-none cursor-pointer mt-10">
              <span className="absolute inset-0 bg-[#E5BC38] transition-transform duration-300 group-hover:translate-x-[2%] group-hover:translate-y-[5%]" />
